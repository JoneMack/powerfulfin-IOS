...
class DSHomeNewsView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        moreBtn.setImage(UIImage.ds_image(color: UIColor.ds_grayColor, size: CGSize(width: 1, height: 15)), for: .normal)
        moreBtn.setImage(UIImage.ds_image(color: UIColor.ds_lineGrayColor, size: CGSize(width: 1, height: 15)), for: .highlighted)
